...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(MODELS_DIR, "ToucanTTS_Poetry_Strophen")  # RENAME TO SOMETHING MEANINGFUL FOR YOUR DATA
    ...
    german_datasets.append(prepare_fastspeech_corpus(transcript_dict=build_path_to_transcript_dict_poetry_stanza(),
                                                     corpus_dir=os.path.join(PREPROCESSING_DIR, "Strophen"),
