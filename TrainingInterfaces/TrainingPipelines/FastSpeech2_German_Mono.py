...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join("Models", "FastSpeech2_German_Mono")
    ...
    datasets.append(prepare_fastspeech_corpus(transcript_dict=build_path_to_transcript_dict_css10de(),
                                              corpus_dir=os.path.join("Corpora", "css10_de"),
                                              lang="de"))    
