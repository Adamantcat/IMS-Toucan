...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join("Models", "FastSpeech2_Zischler")
    os.makedirs(save_dir, exist_ok=True)

    datasets = list()
    datasets.append(prepare_fastspeech_corpus(transcript_dict=build_path_to_transcript_dict_zischler(),
                                              corpus_dir=os.path.join("Corpora", "Zischler"),
                                              lang="de"))
